...
class VideoDetailFeed extends StatefulWidget {
  const VideoDetailFeed(
  ...
  @override
  _VideoDetailFeedState createState() => _VideoDetailFeedState();
}

class _VideoDetailFeedState extends State<VideoDetailFeed>
  ...
  Future<String> _getDetailKonten() async {
    try {
      var response = await http.post(Uri.parse("https://suma.geloraaksara.co.id/api/get_detail_content_feed"),
          body: {
            "id" : widget.idContent,
          });
