...
class VideoPlayerMainFeed extends StatefulWidget {
  const VideoPlayerMainFeed(
      {Key? key, this.mainScreenAnimationController, this.mainScreenAnimation, required this.thumbnail, required this.source})
      : super(key: key);
  ...
  @override
  _VideoPlayerMainFeedState createState() => _VideoPlayerMainFeedState();
}

class _VideoPlayerMainFeedState extends State<VideoPlayerMainFeed>
