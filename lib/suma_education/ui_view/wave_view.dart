          ...
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: AppTheme.nearlyDarkOrange.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      AppTheme.nearlyDarkOrange.withOpacity(0.2),
                      AppTheme.nearlyDarkOrange.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      AppTheme.nearlyDarkOrange.withOpacity(0.4),
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/portal_gelora/bottle.png"),
                ),
              ],
            )
          ],
