...
import 'package:suma_education/suma_education/proposal_approver/ui_part/proposal_form_revision.dart';
...
class ProposalRevision extends StatefulWidget {
  const ProposalRevision({Key? key, required this.animationController, required this.proposalId, required this.idPemohon, required this.noReg, required this.noProposal}) : super(key: key);
  ...
  @override
  _ProposalRevisionState createState() => _ProposalRevisionState();
}

class _ProposalRevisionState extends State<ProposalRevision>
  ...
  void addAllListData() {
    ...
    listViews.add(
      ProposalRevisionForm(
        ...
        noReg: widget.noReg,
        noProposal: widget.noProposal,
        idPemohon: widget.idPemohon,
      ),
    );
