...
class AppointmentAllApproved extends StatefulWidget {
  const AppointmentAllApproved({Key? key, required this.animationController}) : super(key: key);

  final AnimationController? animationController;
  @override
  _AppointmentAllApprovedState createState() => _AppointmentAllApprovedState();
}

class _AppointmentAllApprovedState extends State<AppointmentAllApproved>
