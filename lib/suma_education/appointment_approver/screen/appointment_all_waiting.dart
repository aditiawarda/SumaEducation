...
import 'package:suma_education/suma_education/appointment_approver/ui_part/appointment_list_waiting.dart';
...
class AppointmentAllWaiting extends StatefulWidget {
  const AppointmentAllWaiting({Key? key, required this.animationController}) : super(key: key);

  final AnimationController? animationController;
  @override
  _AppointmentAllWaitingState createState() => _AppointmentAllWaitingState();
}

class _AppointmentAllWaitingState extends State<AppointmentAllWaiting>
